...
public class AsyncJSONDataForListImageChamp extends AsyncTask<String, Void, JSONObject> {

    public Activity activity;
    public AdapterHistList adapter;
    public int idChamp;

    public AsyncJSONDataForListImageChamp(Activity activity, AdapterHistList adapter, int idChamp) {
